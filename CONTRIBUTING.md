...
1. Clone your fork: `git clone https://github.com/YOUR-USERNAME/mcp-atlassian-multi.git`
1. Add the upstream remote: `git remote add upstream https://github.com/sooperset/mcp-atlassian-multi.git`
