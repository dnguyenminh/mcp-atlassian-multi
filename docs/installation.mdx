...
uvx mcp-atlassian-multi --help

# Run with a specific Python version if needed
uvx --python=3.12 mcp-atlassian-multi --help
```
...
docker pull ghcr.io/sooperset/mcp-atlassian-multi:latest
...
```bash
git clone https://github.com/sooperset/mcp-atlassian-multi.git
cd mcp-atlassian-multi
uv sync --frozen --all-extras --dev
uv run mcp-atlassian-multi --help
```

See [CONTRIBUTING.md](https://github.com/sooperset/mcp-atlassian-multi/blob/main/CONTRIBUTING.md) for development setup details.
